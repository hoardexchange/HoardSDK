...
def makeConfig(addr, url, port, outFileName):
    ...
    outFile.write("\t\"BCClient\":\n")
    outFile.write("\t{\n")
    outFile.write("\t\t\"Type\":\"Ethereum\",\n")
...
parser.add_argument("--addr-file", dest="addr_file", action="store", help="file with deployed hoard game center contract address")
...
if args.addr_file:
	makeConfig(loadAddress(args.addr_file), args.client_url, args.client_port, args.output_file)
else:
