...
namespace Hoard
{
    ...
    public class CryptoKittyProvider : Provider
    {
        ...
        override public Result getItems(out GameAsset[] items)
        {
            ...
            if (tokens.Count > 0)
            {
                items = new GameAsset[tokens.Count];
                ...
                for (int i = 0; i < tokens.Count; ++i)
                {
                    var gameAsset = new CryptoKitty(
                        ...
                        null, //TODO: contract
                        1, //totalSupply
                        1000 + (ulong)tokens[0], //assetId   // TODO!!! HoardService assumes assetId is unique
        ...
        override public Result getProperties(GameAsset item, out Property[] props)
        {
            ...
            if (item.AssetType == "cryptokitty")
            {
                ...
                if (cryptoKitty != null)
                {
                    ...
                    props[0] = new Property { name = properties[0], data = genes.ToString() };
        ...
        override public Result getProperties(GameAsset item, string name, out Property[] props)
        {
            ...
            props = null;
            return new Result("CryptoKittyProvider doesn't support '" + name + "'");
        }
    }
}
