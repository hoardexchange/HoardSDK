...
namespace Hoard.Utils.QR
{
    ...
    public class QRCodeGenerator : IDisposable
    {
        ...
        public enum EciMode
        {
            ...
            Default = 0,
            /// <summary>
            /// Default for ascii text data
            /// </summary>
            Iso8859_1 = 3,
            /// <summary>
            /// Some QR code readers do not understand this
            /// </summary>
            Iso8859_2 = 4,
            /// <summary>
            /// Default for UTF-8 data
            /// </summary>
            Utf8 = 26
        }
        ...
        /// <summary>
        /// Creates a QR code data from plain text
        /// </summary>
        /// <param name="plainText">text to encode</param>
        /// <param name="eccLevel">level of encoding</param>
        /// <param name="forceUtf8">if utf-8 encoding should be forced (default = false)</param>
        /// <param name="utf8BOM">if UTF-8 BOM should be appended (default = false)</param>
        /// <param name="eciMode">Extended channel Interpretation mode (leave default)</param>
        /// <param name="requestedVersion">version determines number of modules (leave -1 for auto)</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a QR code data from binary data
        /// </summary>
        /// <param name="binaryData">data to encode</param>
        /// <param name="eccLevel">level of encoding</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a QR code data from bit string
        /// </summary>
        /// <param name="bitString">string to encode</param>
        /// <param name="eccLevel">level of encoding</param>
