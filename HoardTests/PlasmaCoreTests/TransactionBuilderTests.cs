...
namespace HoardTests.PlasmaCoreTests
{
    public class TransactionBuilderTests : IClassFixture<MockupPlasmaAPIServiceFixture>
    {
        ...
        public async void ShouldBuildValidFungibleCurrencyTransaction()
        {
            ...
            PlasmaCore.Transactions.Transaction decodedTransaction = new PlasmaCore.Transactions.Transaction(signedEncodedTx.HexToByteArray());
            ...
            decodedTransaction = new PlasmaCore.Transactions.Transaction(signedEncodedTx.HexToByteArray());
            Assert.Equal(signedEncodedTx, txEncoder.EncodeSigned(decodedTransaction).ToHex(true));
        }
